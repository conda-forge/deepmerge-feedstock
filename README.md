...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/deepmerge-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12333&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/deepmerge-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `deepmerge` can be installed with:

```
conda install deepmerge
```

It is possible to list all of the versions of `deepmerge` available on your platform with:
